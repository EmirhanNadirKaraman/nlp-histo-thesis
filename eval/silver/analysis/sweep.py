...
Usage:
  python -m eval.silver.analysis.sweep --silver eval/data/silver_findings_related15.jsonl \\
                               --pipeline eval/data/pipeline_findings_related15.jsonl
  python -m eval.silver.analysis.sweep --silver ... --pipeline ... --embedder gemini
  python -m eval.silver.analysis.sweep --silver ... --pipeline ... --embedder both
  python -m eval.silver.analysis.sweep --silver ... --pipeline ... --split dev --min-threshold 0.40 --max-threshold 0.80
