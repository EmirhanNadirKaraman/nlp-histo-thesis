...
Usage:
    ...
    python -m nlp_histo.ner.merge_entities_by_umls --output-dir results/umls
    python -m nlp_histo.ner.merge_entities_by_umls --pmcid PMC1234567
    python -m nlp_histo.ner.merge_entities_by_umls --min-occurrences 5
"""
...
Examples:
  ...
  python -m nlp_histo.ner.merge_entities_by_umls --min-occurrences 10

  # Custom output directory
  python -m nlp_histo.ner.merge_entities_by_umls --output-dir results/umls_concepts
        """
    )
