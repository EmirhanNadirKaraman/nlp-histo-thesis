...
from nlp_histo.pipeline.stages.pdf_text_extraction.config import CroppingConfig
from nlp_histo.pipeline.stages.pdf_text_extraction.models.dto import BoundingBox, CroppedMedia, LayoutResult, TableDetectionResult
    ...
    def crop(
        ...
        if self._config.save_table_crops:
            ...
            if self._config.expand_tables_with_footnotes:
                from nlp_histo.pipeline.stages.pdf_text_extraction.components.table_reconstructor import expand_tables_with_footnotes
