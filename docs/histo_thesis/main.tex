...
\newcommand*{\getTitle}{A Pipeline for Extracting Simple Rules from Medical Literature for Automatic Disease Detection in Histopathology}
\newcommand*{\getTitleGer}{A Pipeline for Extracting Simple Rules from Medical Literature for Automatic Disease Detection in Histopathology}
\newcommand*{\getAuthor}{Emirhan Nadir Karaman}
\newcommand*{\getDoctype}{Master's Thesis in Informatics}
\newcommand*{\getSupervisor}{Frederic Mrozinski, M.Sc.}
\newcommand*{\getAdvisor}{apl. Prof. Dr. Georg Groh}
\newcommand*{\getSubmissionDate}{15 July 2026}
