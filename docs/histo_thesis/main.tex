...
\newcommand*{\getSupervisor}{Frederic Mrozinski}
...
\pinktodo{Check all chapter and section numbers for the parts referencing other sections. Add references to them with \~ref\{\}.}
