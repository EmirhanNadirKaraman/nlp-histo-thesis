...
This thesis develops a pipeline that converts published histopathology literature into a structured knowledge-base that is source-faithful and auditable, where every extracted rule can be traced back to the evidence it was sourced from; then evaluates the said pipeline. This introduction chapter explains the motivation behind building such a system, why the problem matters, the research questions the thesis attempts to answer, and summarizes the findings it reaches. The following chapters build and measure the system. 

Section~\ref{section:intro-motivation} explains the motivation behind the thesis; Section~\ref{section:intro-problem-statement} defines the problem, and states the gaps the thesis addresses, and the scope of the contribution. Section~\ref{section:intro-research-questions} presents the five research questions, and Section~\ref{section:intro-contributions} summarizes the contributions that answer them. Section~\ref{section:intro-approach-overview} gives a high-level overview of the entire pipeline. Section~\ref{section:intro-summary-of-findings} is a preview of the main empirical findings of the thesis, including the negative results of agreement-based cascading, with the careful interpretation of the said results. Finally, Section~\ref{section:intro-thesis-structure} concludes the introduction by mapping the chapters that follow in the thesis. 
...
\input{chapters/01_introduction/05_approach_overview}
\input{chapters/01_introduction/06_summary_of_findings}
