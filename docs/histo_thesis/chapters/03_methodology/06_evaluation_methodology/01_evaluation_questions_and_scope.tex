...
This section does not report empirical findings; the purpose of this section is to define the evaluation design, in order to make the results in \pinktodo{Chapter 4, Results} interpretable: what is measured, the metrics that were used for storing, how the datasets and the cases were sampled, and the offline-replay protocol used for cascade calibration and evaluation. 