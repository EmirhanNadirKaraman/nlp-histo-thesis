...
\begin{figure}[htbp]
    ...
    \caption[Knowledge-extraction pipeline.]{Knowledge-extraction pipeline, with each arrow labeled by the typed object it emits. GROUNDING is a filter, so it preserves the type; RESOLVE takes multiple inputs.}
