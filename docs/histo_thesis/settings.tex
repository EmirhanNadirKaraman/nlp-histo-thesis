...
\usepackage{enumitem} % for indented itemization without numbers
...
\newcommand{\pinktodo}[1]{%
    {%
        \setlength{\fboxsep}{3pt}%
        \noindent\fcolorbox{magenta!80!black}{pink!25}{%
            \parbox{0.95\linewidth}{%
                \textcolor{magenta!80!black}{\textbf{\textsc{TODO: #1}}}%
            }%
        }%
    }%
}
