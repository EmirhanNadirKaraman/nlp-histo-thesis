...
**Status / Severity / Surface** — Fixed (2026-07-18, `cd74038`) · Medium · Reproducibility.
...
Fixed in `cd74038` by anchoring the repository-owned defaults to
...
**Status / Severity / Surface** — Fixed (2026-07-18, `7f1bef2`) · Medium · Eval reproducibility.
