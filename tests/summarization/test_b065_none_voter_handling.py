...
The bug:
  ``BatchSummarizationRunner._process_level`` Pass 2 (pre-embedding) iterated
...
def _haiku_only_runner(tmp_path: Path) -> BatchSummarizationRunner:
...
def test_advance_does_not_crash_when_lone_l1_voter_returns_none(
    ...
    from pipeline.stages.summarization.batch import runner as _runner_mod
