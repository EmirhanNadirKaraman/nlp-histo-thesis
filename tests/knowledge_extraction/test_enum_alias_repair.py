...
def test_rule_type_lowercase_validates():
    from pipeline.stages.knowledge_extraction.models import Rule, EvidenceChainItem
...
def test_rule_type_case_repair(raw, expected):
    ...
    from pipeline.stages.knowledge_extraction.models import Rule
    r = Rule.model_validate({
        "rule_id": "R1",
        "type": raw,
        "condition": "IF X",
...
def test_rule_counts_uses_lowercase_field_names():
    from pipeline.stages.knowledge_extraction.models import RuleCounts
